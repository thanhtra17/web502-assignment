          ...
          <span>10:00</span>
              ...
              <td className="px-16 py-2">
                <span className="text-yellow-500 flex">
                  <Link to={`/admin/product/${product._id}/edit`} ><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-700 mx-2" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                    <path fillRule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clipRule="evenodd" />
                  </svg>
                  </Link>

                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-red-700" onClick={() => onRemove(product._id)} viewBox="0 0 20 20" fill="currentColor">
